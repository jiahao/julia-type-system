...
the builtin \lstinline|indmax| function to find the linear index of the value
...
PyPy 2.5.0 was available but the specialized version of NumPy required did
build successfully on neither Python 2.7.9 nor 3.4.3 on OSX. Numba 0.17.0, with
the \lstinline|@jit(nopython=True)| decorator, threw a

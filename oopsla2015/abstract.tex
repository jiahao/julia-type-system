...
We describe how Julia yields comparable performance on standard benchmarks compared to existing technical computing systems, 
as well as how Julia users take advantage of the flexibility of the dynamic dispatch mechanism.
\end{abstract}

...
We describe how Julia yields good performance on standard benchmarks, as well as how Julia users
take advantage of the flexibility of the dynamic dispatch mechanism.
\end{abstract}

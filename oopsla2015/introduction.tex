...
Programs for applied math and science applications often process large amounts of data, and
therefore need to be efficient.
...
%the behavior of the v0.3.2 point release.} based on the hypothesis that dynamic method dispatch is a ma%jor bottleneck in scientific programs.

...
prioritize the arguments from left to right. Julia instead sorts methods by
specificity~\cite{Bezanson2012}. For example, the function \verb|f| defined by 
...
\end{lstlisting}
%
results in a method ambiguity because it is not clear which method gets
dispatched for inputs of type \verb|(Int, Int)|. To solve this problem, Julia

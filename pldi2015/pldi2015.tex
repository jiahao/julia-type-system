...
Languages supporting dynamic multiple dispatch
CLOS
Clojure
Dylan
Xtend

Type systems of these languages

How they resolve implementation details of dynamic multiple dispatch.
...
Dynamic multiple dispatch is opt-in.
...
prioritize the arguments from left to right~\cite{Agarwal1991}. Julia instead

...
whose fields can be accessed directly as \code{P.x} and \code{P.y} 
\todo[color=green]{Alan: P on the line above should be z?}
respectively~
...
University for petascale hierarchical modeling, and a Citibank grant for High
Performance Banking Data Analysis.}

...
register, but must instead be heap allocated. To minimize performance problems
arising from type instability, Julia provides introspection functions like
\verb|code_typed|, which allow users to inspect generated type annotations
and avoid second--guessing the compiler's intentions.

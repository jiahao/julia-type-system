...
specifying \emph{declaratively} how it fits into the whole. As the types one can
dispatch on get more sophisticated, this process works better.
...
properties that are detected at runtime.

Here is the implementation of \verb|factorize| in the base library (annotated
for presentation):

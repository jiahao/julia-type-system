...
Julia is unusal in allowing type tags with nested structure, forming nearly
...
Julia's type inference, for example, which analyzes and annotates Julia
code before machine code generation, is written in Julia itself and runs as
normal code, manipulating both code and types as values.
...
that functions as the supertype of all \verb|SubArray| types. This allows

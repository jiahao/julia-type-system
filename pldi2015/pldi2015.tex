...
\TODO{Something missing about typevars...}

For convenience, an unqualified type parameter can be omitted from a parametric
type declaration. For example, \verb|Array| is a synonym for \verb|Array{T,N}|
...
structure shown in Figure~\ref{fig:lattice}b.
...
element types in the array~\cite{Bezanson2014a}, so an \verb|Array{Float64}|
